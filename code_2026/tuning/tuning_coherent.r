...
write.table(final_fitted_df, paste(path, "tuning_coherent_fitted.txt", sep = "/"),
            sep = " ", col.names = FALSE, row.names = FALSE)
write.table(final_forecasted_df, paste(path, "tuning_coherent_forecast.txt", sep = "/"),
            sep = " ", col.names = FALSE, row.names = FALSE)
